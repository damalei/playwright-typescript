...
const orgColumns: string[] = [
  ...
  'Latest AP Post Date',
  'Latest AR Post Date',
  'Latest Shipment Created Date (GMT+11:00)',
  'Shipments',
  'Payable Invoices',
  'Receivable Invoices',
];
...
const payColumns: string[] = [
  'Invoice Number',
  'Page Last Updated On (GMT+11:00)',
  'Data Last Retrieved On (GMT+11:00)',
  'Creditor Code',
  'Creditor',
  'Invoice Date',
  'Post Date',
  ...
  'Job Numbers',
  'Earliest Shipment Creation Date (GMT+11:00)',
  'Latest Shipment ETA (GMT+11:00)',
  'Earliest Shipment ETD (GMT+11:00)',
  'Database ID',
];
...
const shipColumns: string[] = [
  ...
  'Page Last Updated On (GMT+11:00)',
  'Data Last Retrieved On (GMT+11:00)',
  'Date Shipment Created (GMT+11:00)',
  'House Bill',
  'Master Bill',
  'Consol Number',
  'Transport Mode',
