...
import { DEFAULT_TIMEOUT_IN_MS, FREIGHT_BI_BASE_URL, __saveFilePath } from '../../constants';
...
export class ExploreReceivableInvoices {
    ...
    async clickExportToExcel() {
        ...
        await download.saveAs(__saveFilePath + 'Explore_' + download.suggestedFilename());
