...
test.describe('Edit Columns on Shipper Explore Containers', () => {
  ...
  test.describe('Add Table Columns', () => {
    test('[45.2] User adds Shipment Transport Mode table column on the Explore Organizations Page', async () => {
    ...
    test('[45.2] User adds Shipment Failed to Arrive table column on the Explore Organizations Page', async () => {
    ...
    test('[45.2] User adds Container Seal Number table column on the Explore Organizations Page', async () => {
    ...
    test('[45.2] User adds Container Empty Needed By table column on the Explore Organizations Page', async () => {
